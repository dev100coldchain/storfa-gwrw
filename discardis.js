...
function displayRemiseFivePercent() {
  ...
  if (cartContainer) {
    ...
    Ecwid.Cart.calculateTotal(function (order) {
      ...
      const tontapRemiseHTML = `<p><span style="background-color: ${highlightColor};">&nbsp;Remise 5%&nbsp;</span>&nbsp;sur la prochaine cmde avec paiement à récep de la fact  <span style="background-color: ${highlightColor};">&nbsp;${formattedFivePercentRemise}&nbsp;TTC&nbsp;</span></p>`;
